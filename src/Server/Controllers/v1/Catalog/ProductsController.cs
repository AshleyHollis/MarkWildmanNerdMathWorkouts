...
using MarkWildmanNerdMathWorkouts.Application.Features.Products.Commands.Delete;
using MarkWildmanNerdMathWorkouts.Application.Features.Products.Queries.Export;
using MarkWildmanNerdMathWorkouts.Application.Features.Products.Queries.GetAllPaged;
using MarkWildmanNerdMathWorkouts.Application.Features.Products.Queries.GetProductImage;
using MarkWildmanNerdMathWorkouts.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Threading.Tasks;

namespace MarkWildmanNerdMathWorkouts.Server.Controllers.v1.Catalog
{
