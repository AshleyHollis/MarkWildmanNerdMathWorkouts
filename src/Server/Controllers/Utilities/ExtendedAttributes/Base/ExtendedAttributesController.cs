...
using MarkWildmanNerdMathWorkouts.Application.Features.ExtendedAttributes.Commands.Delete;
...
namespace MarkWildmanNerdMathWorkouts.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
