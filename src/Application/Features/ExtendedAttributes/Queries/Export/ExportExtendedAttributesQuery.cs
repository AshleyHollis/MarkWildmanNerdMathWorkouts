...
using MarkWildmanNerdMathWorkouts.Application.Specifications.ExtendedAttribute;
...
namespace MarkWildmanNerdMathWorkouts.Application.Features.ExtendedAttributes.Queries.Export
{
