...
using MarkWildmanNerdMathWorkouts.Application.Specifications.Catalog;
...
namespace MarkWildmanNerdMathWorkouts.Application.Features.Products.Queries.GetAllPaged
{
