...
using MarkWildmanNerdMathWorkouts.Client.Infrastructure.Routes;
using MarkWildmanNerdMathWorkouts.Shared.Constants.Storage;
using Microsoft.Extensions.Localization;

namespace MarkWildmanNerdMathWorkouts.Client.Infrastructure.Managers.Identity.Authentication
{
